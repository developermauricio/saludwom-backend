...
<head>
    ...
    <![endif]-->
    <title>Nuevo Recurso Resuelto</title>
    <link
...
<div
    style="display: none;">Nuevo Recurso Resuelto</div>
<div role="article" aria-roledescription="email" aria-label="Verify Email Address" lang="es">
    <table style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; width: 100%;" width="100%"
           cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td align="center"
                style="--bg-opacity: 1; background-color: #ffffff; background-color: #ffffff; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                    ...
                    <tr>
                        <td class="sm-py-32 sm-px-24"
                            ...
                            <a href="{{ env('APP_URL_FRONT') }}">
                                <img src="{{ env('APP_URL') }}/assets/images/logo-saludWoM.png" width="300"
                                     alt="SaludWoM"
                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <p>
                                            El o la paciente {{ $user['name'] }} {{ $user['last_name'] }} a resuelto el recurso. Ingresa dando clic en el bóton "Ver Recurso" para mayor información
                                        </p>
                                        ...
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #D85C72; background-color: #D85C72; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                    ...
                                                    <a href="{{ env('APP_URL_FRON_ADMIN') }}//objetivos/objetivos/{{ $valuationSlug }}"
                                                       style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: #ffffff; text-decoration: none;">Ver recurso &rarr;</a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 12px; padding-left: 48px; padding-right: 48px; --text-opacity: 1; text-align: center !important; color: rgba(241, 240, 240, 0.38); color: rgba(236, 239, 241, var(--text-opacity));">
                                        <p align="center"
                                           style="cursor: default; margin-bottom: 16px; text-align: center !important;">
                                            <a href="https://www.facebook.com/saludwom"
                                               style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ env('APP_URL') }}/assets/images/facebook-2.png" width="20"
                                                    alt="Facebook"
                                                    style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                            &bull;
                                            <a href="#"
                                               style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ env('APP_URL') }}/assets/images/twitter.png" width="20"
                                                    alt="Twitter"
                                                    style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                            &bull;
                                            <a href="https://www.instagram.com/saludwom/"
                                               style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                                    src="{{ env('APP_URL') }}/assets/images/instagram-3.png" width="20"
                                                    alt="Instagram"
                                                    style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                        </p>
                                        <p style="--text-opacity: 1; color: #666666 !important; color: #666666 !important; text-align: center !important;">
                                            ...
                                            <a href="#" class="hover-underline"
                                               style="--text-opacity: 1; color: #792141; color: #792141; text-decoration: none;">Términos</a>
                                            y
                                            <a href="#" class="hover-underline"
                                               style="--text-opacity: 1; color: #792141; color: #792141; text-decoration: none;">Políticas
                                                de Privacidad</a>.
                                        </p>
                                    </td>
                                </tr>
