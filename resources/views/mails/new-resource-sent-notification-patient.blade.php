...
<head>
    ...
    <![endif]-->
    <title>Nuevo Recurso Asignado</title>
    <link
...
<div style="display: none;">Tienes un nuevo recurso asignado.</div>
                                    ...
                                    <td class="sm-px-24"
                                        ...
                                        <p class="sm-leading-32"
                                           style="font-weight: 600; font-size: 20px; margin: 0 0 16px; --text-opacity: 1; color: #263238; color: #263238">
                                            Se te ha asignado un nuevo recurso. 🔥
                                        </p>
                                        <p style="margin: 0 0 24px;color: #666666 !important;">
                                            Para el tratamiendo de <strong>{{$treatment}}</strong>, el especialista <strong>{{ $doctor['name'] }} {{ $doctor['last_name'] }}</strong>, ha enviado un nuevo recurso. Por favor responde a este rescurso para continuar con tu tratamiento.<br>
                                            El recurso es para tu objetivo con el plan <strong>{{$plan['name']}}</strong>.
                                        ...
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #D85C72; background-color: #D85C72; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                    ...
                                                    <a href="{{ env('APP_URL_FRONT') }}/webapp/objetivos/{{ $valuationSlug }}"
