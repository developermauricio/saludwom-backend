...
<head>
    ...
    <![endif]-->
    <title>Tu cita en Salud WoM</title>
    <link
...
<div style="display: none;">Tu cita para el tratamiento de {{$treatment}} se encuentra confirmada.</div>
                                    ...
                                    <td class="sm-px-24"
                                        ...
                                        <p class="sm-leading-32"
                                           style="font-weight: 600; font-size: 20px; margin: 0 0 16px; --text-opacity: 1; color: #263238; color: #263238">
                                            {{ count($appointments) > 0 ? 'Tus citas ' : 'Tu cita ' }}para el tratamiento de {{$treatment}} se  {{ count($appointments) > 0 ? 'encuentran ' : 'encuentra' }} {{ count($appointments) > 0 ? 'confirmadas ' : 'confirmada' }}. 🗓
                                        </p>
